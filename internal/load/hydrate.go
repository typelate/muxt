...
// packageWithReceiver reads the package at dir and the receiver type. The
// receiver is read first, so a missing package is reported before a
// missing receiver -- both by Receiver -- and either before a templates
// variable that does not evaluate.
