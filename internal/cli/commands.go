...
func generateCommand(workingDirectory string, args []string, getEnv func(string) string, stdout, stderr io.Writer) error {
	...
	// - If using multiple files mode: delete files that weren't regenerated
	// - If using single file mode: delete ALL old generated files (user switched from multiple to single)
...
func findGeneratedFiles(workingDirectory, routesFunction string) (map[string]bool, error) {
	...
	for _, entry := range entries {
		...
		// Format: // Code generated by muxt generate [flags]. DO NOT EDIT.
