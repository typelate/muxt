...
For form-based mutations (POST with form data), see [Forms](../muxt_forms/SKILL.md).
...
| `form` | struct | POST/PUT/PATCH with form data (see [Forms](../muxt_forms/SKILL.md)) |
...
For form-related test cases, see [Forms](../muxt_forms/SKILL.md#test-cases-cmdmuxttestdata).
