...
There will be much less friction in changing signatures/identifiers of generated code — which also makes it easier to accidentally break code that imports the generated identifiers.
