...
//go:generate go run github.com/typelate/muxt generate --receiver-type Backend --receiver-type-package github.com/typelate/muxt/docs/example --routes-func TemplateRoutes
...
func ChangeTemplateDataResult[NewResultType, PrevResultType any](td *TemplateData[PrevResultType], result NewResultType, okay bool, errList ...error) *TemplateData[NewResultType] {
	return &TemplateData[NewResultType]{receiver: td.receiver, response: td.response, request: td.request, redirectURL: td.redirectURL, statusCode: td.statusCode, result: result, okay: okay, errList: errList}
}
