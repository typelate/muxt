// Code generated by muxt generate --use-receiver-type=clock. DO NOT EDIT.
// muxt version: (devel)
...
func TemplateRoutes(mux *http.ServeMux, receiver RoutesReceiver) TemplateRoutePaths {
	...
	mux.HandleFunc("GET /time", func(response http.ResponseWriter, request *http.Request) {
		...
		flusher.Flush()
		var mut sync.Mutex
		receiver.Time(ctx, lastEventID, func(result string) error {
			...
			if err := templates.ExecuteTemplate(buf, "GET /time sse(Time(ctx, lastEventID, send))", &td); err != nil {
